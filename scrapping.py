...
#lasso reg
    def lasso_reg(self):
        ...
        self.abs_ls = mean_absolute_error(self.y_test, self.y_pred_lasso)
        ...
        print(self.abs_ls, self.sqrt_ls, self.score_ls)
...
#ridge reg
    def ridge_reg(self):
        ...
        self.abs_rd = mean_absolute_error(self.y_test, self.y_pred_ridge)
        ...
        print(self.abs_rd, self.sqrt_rd, self.score_rd)

#making final nmodel from highest r2 score
    def final_model(self):
        print("Linear:", self.abs_lr, self.sqrt_lr, self.score_lr)
        print("Lasso:", self.abs_ls, self.sqrt_ls, self.score_ls)
        print("Ridge:", self.abs_rd, self.sqrt_rd, self.score_rd)
